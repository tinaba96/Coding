class student:
    ...
    def get_exam_score(self, exam):
        # Retrieve the score for a specific exam
        return self.exam_scores.get(exam, "No score recorded for this exam")

    def get_all_scores(self):
        scores = {}
        for course in self.courses:
            for exam in course.exams:
                if exam in self.exam_scores:
                    scores[exam] = self.exam_scores[exam]
        return scores
